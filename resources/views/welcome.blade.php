@php
    ...
    $projects = [
        [
            ...
            'company' => 'PT Kalventis Sinergi Farma',
            'period' => '2023 - 2024',
            'summary' => 'Web platform for landing pages, campaign pages, and event workflows with role-based permissions and approvals.',
            'tags' => ['C#', 'ASP.NET Core', 'Role Management'],
        ],
        [
            'title' => 'Careline Dashboard',
            'company' => 'PT Coway International Indonesia',
            'period' => '2022 - 2023',
            'summary' => 'Desktop application for lead registration, FAQ access, customer search, and service availability checks.',
            'tags' => ['C#', 'Desktop App', 'Operations'],
        ],
        [
            'title' => 'Cody Manager',
            'company' => 'PT Coway International Indonesia',
            'period' => '2022 - 2023',
            'summary' => 'Operational web app for assignment handling, material requests, and meeting activity review.',
            'tags' => ['ERPNext', 'Workflow App', 'Operations'],
        ],
        [
            'title' => 'Coway ERP',
            'company' => 'PT Coway International Indonesia',
            'period' => '2022',
            'summary' => 'ERPNext and Frappe implementation covering API work, bug fixes, and frontend data customization.',
            'tags' => ['Frappe', 'Python', 'JavaScript'],
        ],
        [
            'title' => 'Gold Trading System Desktop',
            'company' => 'Infonet Global Tech',
            'period' => '2019 - 2022',
            'summary' => 'Desktop trading system for jewelry transactions with role-based UI and order flow management.',
